...
#         self.declare_parameter('amplitude_deg', 60.0)
...
#         self.declare_parameter('can_id', 0x004)          # standard 11-bit
...
class StepSteerCanNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('start_deg', 5.0)          # start at 5°
        self.declare_parameter('step_period_s', 4.0)      # hold each step for 2s
        self.declare_parameter('publish_rate_hz', 50.0)   # bus send frequency

        # CAN params
        self.declare_parameter('can_interface', 'can0')
        self.declare_parameter('can_id', 0x004)
