...
from geometry_msgs.msg import QuaternionStamped, TwistStamped, Vector3
...
class HeadingVelVisualizer(Node):
    def __init__(self):
        ...
        # ⚠️ Assume /vel is TwistStamped here.
    ...
    def update_marker(self):
        ...
        # Orientation: from velocity vector (not msg.quaternion!)
